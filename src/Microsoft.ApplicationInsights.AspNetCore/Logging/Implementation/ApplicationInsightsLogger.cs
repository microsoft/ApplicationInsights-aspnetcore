namespace Microsoft.ApplicationInsights.AspNetCore.Logging
{
    ...
    internal class ApplicationInsightsLogger : ILogger
    {
        ...
        {
            var telemetryAsISupportProperties = telemetry as ISupportProperties;

            if(telemetryAsISupportProperties != null)
            {            
                IDictionary<string, string> dict = telemetryAsISupportProperties.Properties;
